                ...
                <div className="pt-5 flex items-center justify-between gap-4 text-xs">
                  <div className="flex items-center gap-2 font-mono text-muted min-w-0 flex-1">
                    ...
                    <Button
                      ...
                      aria-label="复制单号"
                      className="hover:text-foreground transition-colors inline-flex items-center gap-1 h-auto min-h-0 min-w-0 p-0 bg-transparent cursor-pointer shrink-0"
                    >
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-muted leading-relaxed mt-1">
                    资金直接存管于官方账户，通过智能清算系统完成实时鉴权与核销，资金流向合规、透明。
                  </p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-muted leading-relaxed mt-1">
                    全站使用 SSL/TLS 高强度传输加密算法，确保您的支付账号、密码和交互记录不被窃听。
                  </p>
                </div>
              </div>
            </div>
