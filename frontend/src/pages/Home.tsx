...
import { Zap, Code, ShieldCheck, ArrowRight, LayoutDashboard, Terminal } from 'lucide-react'
      ...
      <section className="pt-20 pb-12 px-6 max-w-4xl mx-auto text-center">
        ...
        <div className="flex items-center justify-center gap-4">
          <Button
            render={(props) => <Link to="/login" {...(props as any)} />}
            variant="primary"
            className="px-7 py-3.5 text-sm font-medium rounded-xl flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white shadow-sm transition-colors h-auto cursor-pointer"
          >
